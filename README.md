...
- `seasonal-observatory`: a bilingual solar-term, poetry calendar, and urban phenology site with original observation guides, public-domain poem notes, an interactive 24-term wheel, a poem-card generator, source cards, and policy pages.
