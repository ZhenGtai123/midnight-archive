...
export const seasonalTermCalendar = [
  ...
  },
  {
    ...
    coreEssay: {
      title: "春分：把一天重新校准",
      deck:
        "春分的重点不是一句“昼夜平分”，而是用光线、风向、植物和人的作息，重新校准一年里最容易被忽略的平衡感。",
      sections: [
        {
          heading: "不要只看日历上的平分",
          body: [
            "春分常被解释为昼夜接近等长。这个说法适合作为入口，却不适合成为整篇内容的终点。真正能让读者记住春分的，是它如何进入一个普通城市房间：早晨的光比惊蛰时更直接，傍晚还能在墙上停留一会儿，窗外枝条不再只是灰色线条，而开始显出柔软的边缘。",
            "观察春分，可以把“平分”理解成一次校准。冬天把注意力推向室内，春分把人重新推回窗边、阳台和街道。白天变得足够长，夜晚仍保留一点冷意，这种不偏不倚的阶段最适合建立记录习惯：同一面墙、同一棵树、同一条通勤路，连续看七天，比背下一段节气定义更有用。"
          ]
        },
        {
          heading: "用光线做春分的尺",
          body: [
            "春分最稳定的观察工具是光。选择上午九点、正午十二点、傍晚五点三个时段，拍摄同一张桌子或同一面墙。你会发现光斑的位置、边缘和停留时间都在改变。它不是漂亮背景，而是太阳高度、建筑遮挡和房间朝向共同留下的证据。",
            "如果住在高楼，不一定能看见完整日出日落，也不用因此放弃观察。楼间阴影、窗帘上的亮边、书桌上植物的朝向、走廊里什么时候需要开灯，都能成为春分的尺。节气观察的价值正在这里：它把宏大的天文变化缩小成读者可以亲手复查的生活细节。"
          ]
        },
        {
          heading: "把早春物候放回城市",
          body: [
            "春分前后，植物变化会变得密集。行道树可能还没有完全成荫，但芽点、浅草、早开的花和鸟声已经能组成一套早春索引。记录时不要急着辨认所有物种，可以先写位置：树池、围墙脚、河边坡地、地铁口花坛、楼下无人修剪的角落。位置能说明城市热量、水分和人类维护如何改变春天。",
            "《钱塘湖春行》里的早莺、新燕、浅草给春分页提供了诗意入口，但页面不应停在诗意上。更好的处理方式，是把诗里的意象转成观察问题：今天有没有听见新的鸟声？泥土是否比上周松？浅草是否已经盖住裸地？当诗句被翻译成问题，它就从装饰变成方法。"
          ]
        },
        {
          heading: "建立春季第一张记录表",
          body: [
            "春分适合成为全站的春季核心页，因为它能连接光线、植物、风、雨和作息。可以为读者提供一张很简单的记录表：日期、天气、同一位置光线、植物变化、身体感受、下一次复查。每栏只写一句，连续七天就足够形成个人春分档案。",
            "这类页面对 AdSense 准备也更有价值。它不是复制百科，也不是堆砌诗词，而是给读者一个可执行的观察框架。读者可以当场开始记录，之后还能回到立夏、夏至、秋分页面做比较。站点真正的留存理由，来自这种可以持续使用的结构。"
          ]
        },
        {
          heading: "让春分成为复访起点",
          body: [
            "春分页还应该告诉读者下一次何时回来。七天后回来看芽点，清明前回来看雨和行路，谷雨时再看同一处植物是否已经进入密集生长期。这样的提醒不会增加复杂功能，却能让页面拥有时间上的后续。",
            "如果未来做城市观察日志，春分可以作为第一张样表。读者提交的不是模糊感想，而是同一地点、同一时间段、同一问题的短记录。这样积累下来的内容，才会慢慢形成站点自己的资料价值。"
          ]
        }
      ],
      checklist: [
        "连续七天拍同一面墙或同一张桌子的光斑。",
        "记录三处早春植物：位置、颜色、是否有新芽。",
        "把一首春日诗句改写成三个可观察问题。"
      ]
    }
  },
  ...
  },
  {
    ...
    coreEssay: {
      title: "夏至：最长白昼怎样改变城市",
      deck:
        "夏至不是最热的一天，却常常是光线最强、影子最短、傍晚最晚收场的节点。它适合用树荫、窗边热量和晚间活动来观察。",
      sections: [
        {
          heading: "最长白昼不等于最热",
          body: [
            "夏至最容易被误读成“最热”。事实上，热量积累和地表响应会滞后，真正的酷暑往往在小暑、大暑展开。夏至更准确的关键词是光：白昼达到高点，太阳高度很高，正午影子收得很短，傍晚迟迟不肯暗下来。把这个差别讲清楚，页面就会比泛泛的季节介绍更可信。",
            "读夏至，第一步是把温度计放到次要位置，先看影子。中午十二点到一点之间，拍同一棵树、同一根路灯杆或同一栋楼的阴影。影子短到几乎贴在物体脚边时，读者会直接理解“太阳高度”不是抽象词。这样的观察比一段历法解释更容易被记住。"
          ]
        },
        {
          heading: "树荫是夏至的城市仪器",
          body: [
            "城市里的夏至，最实用的仪器不是天文台设备，而是树荫。树荫覆盖哪里，行人就走向哪里；公交站有没有遮挡，会直接改变候车姿势；咖啡店、便利店和地铁口的冷气边界，也会在这一天变得格外清楚。热并不是均匀铺开的，城市材料会把它分成很多小气候。",
            "可以为夏至建立一条“阴影路线”：从家到地铁、从公司到午餐地点、从商场到公交站，记录每一段有没有可用阴影。这样的内容既有季节感，也有实际价值。它不需要夸张成避暑指南，只要让读者意识到路线、建筑和树木如何共同决定体感。"
          ]
        },
        {
          heading: "傍晚是夏至最好的入口",
          body: [
            "夏至的傍晚往往比正午更适合写。正午的光太强，很多人只想躲开；傍晚则能看见白昼如何缓慢退场。窗边光线延长，楼体边缘仍然发亮，公园和河边的人流变多，晚餐时间被推迟，夜跑、散步和露天座位重新成为城市生活的一部分。",
            "《夏日南亭怀辛大》里的“散发乘夕凉”给夏至页提供了很好的情绪入口。关键是不要把它处理成单纯古诗欣赏，而要继续问：今天的晚凉从几点开始？窗台和地砖在晚上九点还有余热吗？开窗带来的是凉风、湿气，还是街道热气？这样诗句就能接上现代城市的具体感受。"
          ]
        },
        {
          heading: "从夏至连接后面的热",
          body: [
            "夏至也是全站夏季内容的结构节点。它向前连接立夏、小满，向后连接小暑、大暑。立夏写初夏，小满写丰盈，夏至写光线峰值，小暑和大暑写热量堆积。把这条线讲清楚，读者就能看见夏天不是一个单调的热字，而是一组逐渐变化的阶段。",
            "一个好的夏至页，应当帮助读者做比较：今天的影子和立秋有什么不同？今天的傍晚和小暑有什么不同？今天的树荫和春分有什么不同？当页面主动制造比较关系，站点就会从单篇文章变成阅读网络。"
          ]
        },
        {
          heading: "把热写成边界，而不是恐吓",
          body: [
            "夏至页面可以提醒读者留意热，但不需要制造焦虑。更好的写法是描述边界：阳光和阴影的边界、冷气和室外空气的边界、白天活动和傍晚活动的边界。边界一旦被看见，读者就会自然理解如何调整路线和时间。",
            "这种写法也让内容更稳定。它不依赖某一年某一天的极端天气，而是给读者一套每年都能复用的方法。等站点换到独立域名后，夏至页可以继续增加城市案例、照片和可下载记录表。"
          ]
        }
      ],
      checklist: [
  ...
  },
  {
    ...
    coreEssay: {
      title: "秋分：清朗怎样进入一天",
      deck:
        "秋分和春分一样接近昼夜平分，但它不是春分的重复。秋分更像一次收束：光线变低，空气变清，夜晚重新变得有重量。",
      sections: [
        {
          heading: "秋分不是春分的镜像",
          body: [
            "秋分常被简单解释为昼夜平分，这和春分相似，但两者的体感完全不同。春分指向生长，秋分指向收束；春分的光线带着湿润和上升，秋分的光线则更低、更清、更有边缘。写秋分时，如果只重复“昼夜等长”，页面就会失去季节性。",
            "读者可以从黄昏开始理解秋分。太阳落得比夏天早，天空颜色从亮白转向更干净的蓝灰，云边变得清楚，楼体轮廓也更利落。城市光污染会遮住星空，却遮不住透明度变化。把这种清朗写具体，秋分就不会只是一张日历卡。"
          ]
        },
        {
          heading: "月色、露意和夜的边界",
          body: [
            "秋分前后，月光和夜色很容易进入节气叙事。杜甫写“露从今夜白”，王维写“明月松间照”，这些诗句并不只属于山林。城市里也有月色：阳台栏杆上的亮边、玻璃幕墙里的反光、夜跑路线上的树影、下班路上更早亮起的灯。",
            "页面可以引导读者做一个夜间观察：同一路线，选三晚记录月亮是否可见、空气是否干爽、衣领是否需要拉起、树叶颜色在路灯下是否变暗。这样的观察能把诗句从远方拉回脚边，让秋分成为可以复查的生活经验。"
          ]
        },
        {
          heading: "市场和餐桌里的转向",
          body: [
            "秋分也适合写食物，但不应写成夸张的养生清单。更可信的做法，是观察市场和餐桌的变化：水果摊的颜色开始变深，热汤重新有吸引力，烘焙和熟食的气味比冷饮更容易被注意，晚餐后散步的体感也从散热变成保温。",
            "这些内容看似日常，却能支撑站点的独特性。节气并不只在自然物候里发生，也在人的购买、烹饪和时间安排里发生。秋分页面如果能把天空、夜路、市场和餐桌放在一起，就会比单纯讲民俗更有现代读者价值。"
          ]
        },
        {
          heading: "做一张秋季比较表",
          body: [
            "秋分是秋季内容的中心页，可以向前连接立秋、处暑、白露，向后连接寒露、霜降、立冬。它适合承接“转向已经发生，但冬天还没到”的阶段。页面可以提供比较表：黄昏时间、夜风、露水、衣物、市场、睡眠，每项一行。",
            "这样的表格不需要复杂交互，先用文字方法就够了。读者只要连续记录几天，就能看见秋分前后生活节奏如何变动。等后续接入更高阶功能时，这套结构可以自然升级成观察日志、城市比较或 AI 辅助整理，而不是为了炫技临时硬加。"
          ]
        },
        {
          heading: "记录没有变化的日子",
          body: [
            "秋分观察还有一个重要技巧：允许没有变化。某一天天空仍然闷，夜风仍然热，市场也没有明显转向，这些都不是失败。把无变化写下来，反而能帮助读者理解季节不是准点切换，而是在反复和延迟中慢慢成立。",
            "这也是本站和薄内容站的区别。我们不急着把每个节气写成固定结论，而是保留差异、延迟和空记录。读者越能在页面里看见自己的真实经验，越可能把这个站当成长期工具。",
            "秋分的空记录尤其有用，因为它能和寒露、霜降形成对照：今天没有明显冷意，十天后是否出现？今天云边还不清楚，下一次雨后是否改变？这些问题会自然引导读者继续读下去。"
          ]
        }
      ],
      checklist: [
        "黄昏拍三天同一片天空，比较云边和楼体轮廓。",
        "夜间走同一路线，记录月光、风感和衣领变化。",
        "写下市场或餐桌上最早出现的三个秋季信号。"
      ]
    }
  },
  ...
  },
  {
    ...
    coreEssay: {
      title: "冬至：最短白昼怎样进入房间",
      deck:
        "冬至可以从天文学开始，但不应停在天文学。真正能让人反复回来的，是它如何改变房间光线、晚餐时间、热饮需求和团聚感。",
      sections: [
        {
          heading: "把天文节点落到书桌上",
          body: [
            "冬至是一年里白昼很短、太阳高度较低的节点。这个知识很容易查到，难的是把它写成读者能立刻感知的页面。最好的入口是书桌：上午光线是否能进入房间，中午光线落在哪里，下午几点开始必须开灯。一个固定位置，比抽象图表更能说明冬至。",
            "选择一张桌子、一面墙或一盆窗边植物，上午、中午、傍晚各拍一次。连续三天之后，读者会发现冬至不是一句“昼短夜长”，而是一套重新安排日常的条件：工作时间、阅读光线、做饭节奏、室内植物的方向，都在被短白昼轻轻推着走。"
          ]
        },
        {
          heading: "房间朝向让冬至变得不同",
          body: [
            "同一个冬至，在不同房间里完全不一样。南向房间可能拥有短暂但珍贵的低角度阳光；北向房间更依赖反射光和灯具；楼间距、窗外树木、阳台遮挡都会改变体感。一个负责任的节气页，应当承认这种差异，而不是把所有读者写进同一个标准答案。",
            "记录时可以加入三个条件：朝向、楼层、遮挡。它们不需要很专业，只要足够让读者复查。比如“十六层南向，下午三点半楼体遮挡书桌”；或者“三层北向，全天无直射，下午五点开灯”。这些短句比泛泛的“注意保暖”更有信息密度。"
          ]
        },
        {
          heading: "灯、热食和团聚不是装饰",
          body: [
            "冬至常被写到饺子、汤圆和团圆。本站可以写这些，但不把它们当成孤立习俗。更值得解释的是：短白昼为什么会让人需要稳定感？灯光提前出现，热食变得有吸引力，晚餐被赋予仪式感，和家人联系也更容易被想起。食物和团聚，是人对季节压力的温和回应。",
            "《邯郸冬至夜思家》里的灯前影子，适合作为冬至页的情绪核心。它不是简单怀旧，而是把短白昼、旅途、灯光和思家放进同一个画面。现代读者即使不在驿站，也会在加班后的办公桌、租住的房间或回家路上遇到类似的时间感。"
          ]
        },
        {
          heading: "冬至是全站的年度轴心",
          body: [
            "冬至适合作为全站的年度轴心页。它一边连接小雪、大雪、小寒、大寒，一边连接立春之后的回升。只要把冬至写厚，读者就能理解节气不是孤立的民俗标签，而是太阳、房间、身体和社会关系共同组成的年度结构。",
            "后续可以把冬至页面继续扩展成工具：房间光线记录表、第一次开灯时间、窗边植物观察、冬季晚餐档案。现在先用长文把观察方法讲清楚，避免功能先行而内容空心。对一个准备长期经营的网站来说，这种支柱页比短期花哨更可靠。"
          ]
        },
        {
          heading: "给来年留下对照",
          body: [
            "冬至尤其适合做年度对照。今天几点开灯，明年同一天是否一样？今年窗边植物是否停长，明年是否因为摆放位置改变而不同？今年和家人联系的方式是什么，明年又会不会变化？这些问题让冬至页天然拥有时间深度。",
            "如果读者愿意每年回来补一条记录，这个页面就不再只是一次阅读，而会成为个人档案的入口。站点后续可以把这种对照扩展到春分、夏至、秋分，形成完整的四季复访机制。"
          ]
        }
      ],
      checklist: [
        "上午、中午、傍晚各拍一次同一张书桌的光。",
        "记录一周内每天第一次开灯的时间。",
        "写下冬至当天让你感到稳定的三件小事：灯、食物、联系或房间布置。"
      ]
    }
  }
];
...
export const seasonalStaticPages = [
  ...
  },
  {
    ...
    body:
      "<p class=\"lead\">当前版本已经生成 24 个节气资料页，并把春分、夏至、秋分、冬至扩写为第一批核心长文。申请 AdSense 前，建议继续把其他资料页逐步扩写成更厚的独立长文，并增加 8-12 篇专题文章，形成稳定内链网络。</p><p>优先路线：四季核心节气页、城市物候专题、居家节气专题、雨水与湿度专题、光线与历法专题。每篇正式文章应包含原创观察、来源卡片、行动清单和继续阅读入口。</p>"
  }
];

export const seasonalExpansionPlan = [
  "把剩余节气资料页逐步扩写为独立长文，每篇至少 1200-1800 中文字。",
  "继续加厚春分、夏至、秋分、冬至四个核心页，并为它们补可下载观察表。",
